<template>
  <footer class="bg-base-800 divide-y px-4 text-gray-100">
    <div
      class="container mx-auto flex flex-col justify-between space-y-8 py-10 lg:flex-row lg:space-y-0"
    >
      <div class="lg:w-1/3">
        ...
        <br />
        <span name="attribution 1" class="text-xs text-gray-400">Made with vuefolio</span>
      </div>
    ...
    <div class="py-6 text-center text-sm">© 2024 John Doe.</div>
  </footer>
</template>
